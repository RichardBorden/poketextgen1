...
TMNotebookText::
	...
	para "There are 50 MMs"
	line "in all."

	para "There are also 5"
	line "SMs that can be"
...
_ViridianBlackboardSleepText::
	...
	para "Use DROWSY CURE"
	line "to wake them up!"
	prompt
...
_UnveiledGhostText::
	text "SILPH SCOPE"
	line "unveiled the"
	cont "identity of the"
	cont "YUUREI!"
	prompt

_GhostCantBeIDdText::
	text "Darn! The YUUREI"
	line "can't be ID'd!"
	prompt
